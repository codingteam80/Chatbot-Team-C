from chains.rag.answer_repair import (
    html,
    json,
    re,
    unicodedata,
...
def prepare_context_docs(
    ...
    # This is the only final context filter before prompt creation.
...
def build_prompt_from_context(question, context_docs, chat_history=""):
    # Create the prompt from the already selected final context docs.
